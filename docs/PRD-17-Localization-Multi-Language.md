...
Buddy's AI chat responses are generated by the LLM (Kimi K2.5 / Claude). These do NOT need pre-translation — the model responds in whatever language the user writes in.
